...
const Navbar = ({ session }) => {
  ...
  return (
    <div className="fixed top-0 w-full px-5 h-[82px] bg-white/60 z-50">
      <div className="flex items-center justify-between h-full  mx-auto ">
          ...
          <Link href={"/"} className="hidden lg:block">
            <div className="flex justify-center items-center ">
              <Image
                ...
                alt="home"
              />
              <span className=" w-[82px] text-green-01 text-[24px] leading-[30px] text-center">
                Home
              </span>
            </div>
          </Link>
        ...
        {session && (
          <div className="flex items-center justify-center gap-[14px] relative">
            ...
            {toggle && (
              <div
                className=" top-[120%]  right-0 absolute w-fit  bg-[#fff] rounded-[15px] px-2 py-4 shadow-01 "
                onClick={() => setToggle((prev) => !prev)}
              >
